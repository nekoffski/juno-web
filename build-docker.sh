...
echo "  docker run -d -p 8080:80 -e REACT_APP_JUNO_PROXY=localhost:8080 $IMAGE_NAME:$IMAGE_TAG"
echo ""
echo "Example with custom proxy:"
echo "  docker run -d -p 8080:80 -e REACT_APP_JUNO_PROXY=myserver.local:9000 $IMAGE_NAME:$IMAGE_TAG"
echo ""
